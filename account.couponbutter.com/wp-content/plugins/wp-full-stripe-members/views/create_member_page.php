...
<div class="wrap">
    ...
    <p>Use this form if you'd like to manually create a new member. Note this is not the recommended way, you should use the subscription forms and roles to create members when users subscribe.
        Use this if you must import members from before WP Full Stripe Members was installed.  Please remember that manually created members will not automatically update or synchronize with Stripe -
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <p class="description">If you know it, enter the Stripe Customer ID for this member, otherwise leave blank.</p>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
                ...
                <td>
                    ...
                    <p class="description">If they are already subscribed to a Stripe plan enter the Stripe Subscription ID for this member, otherwise leave blank.</p>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
                ...
                <td>
                    <label class="radio">
                        ...
                        <input type="radio" name="wpfs_members_live_mode" id="wpfsmLiveY" value="1" checked="checked"> Live
                    </label>
                    <p class="description">Is this a Test mode or Live mode member? (applies to Stripe customer & subscription IDs)</p>
                </td>
            </tr>
        </table>
        <p class="submit">
