    ...
    jQuery.post(ajaxurl, data, function (response) {
        ...
        if (response && response.status && 'OK' == response.status) {
            if (response.total_count_with_subscriptions) {
                ...
                jQuery('div[data-step=1] .well').html('An error occured during import!');
            }
        } else {
            jQuery('div[data-step=1] .well').html('An error occured during import!');
        }
...
var importWizardStep3 = function () {
    ...
    jQuery.post(ajaxurl, data, function (response) {
        ...
        if (response && response.status && 'OK' == response.status) {
            ...
            jQuery('div[data-step=3] .well').html('An error occured during import!');
        }
    });
};
...
var importWizardStep5 = function () {
    ...
    jQuery.post(ajaxurl, data, function (response) {
        ...
        if (response && response.status && 'OK' == response.status) {
            ...
            jQuery('div[data-step=5] .well').html('An error occured during import!');
        }
