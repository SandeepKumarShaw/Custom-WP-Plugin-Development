...
/* @var $plans Stripe_List */
$plans = MM_WPFS::getInstance()->get_plans();
/* @var $plan Stripe_Plan */
$plan = null;
		...
		<form class="form-horizontal" action="" method="POST" id="edit-subscription-plan">
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						<?php echo isset( $plan->trial_period_days ) ? $plan->trial_period_days . ' days' : 'No trial' ?>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
					...
					<td>
						<input type="text" class="regular-text" name="plan_display_name" id="form_plan_display_name" value="<?php echo $plan->name ?>"/>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
					...
					<td>
						<input type="text" class="regular-text" name="plan_statement_descriptor" id="form_plan_statement_descriptor" value="<?php echo $plan->statement_descriptor ?>"/>
					</td>
				</tr>
			</table>
			...
			<p class="submit">
				...
				<a href="admin.php?page=fullstripe-subscriptions&tab=plans" class="button">Cancel</a>
