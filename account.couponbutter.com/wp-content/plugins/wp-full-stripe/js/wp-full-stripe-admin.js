...
function findTemplateById() {
    ...
    if (emailReceipts.currentTemplateId == 'paymentMade') {
        selectedTemplate = emailReceipts.paymentMade;
    } else if (emailReceipts.currentTemplateId == 'subscriptionStarted') {
        selectedTemplate = emailReceipts.subscriptionStarted;
    } else if (emailReceipts.currentTemplateId == 'subscriptionFinished') {
        selectedTemplate = emailReceipts.subscriptionFinished;
    }
