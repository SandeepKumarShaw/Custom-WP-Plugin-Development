...
class MM_WPFS_Database {
	 ...
	 * @throws Exception
	 */
	function fullstripe_insert_payment( $payment, $address, $customerID, $email, $formId, $formType ) {
		global $wpdb;
	...
	function cancel_subscription( $id ) {
		error_log( 'DEBUG: ' . 'cancel_subscription(): ' . "cancel subscription, id={$id}" );
		global $wpdb;
	...
	public function cancel_subscription_by_stripe_subscription_id( $stripeSubscriptionID ) {
		error_log( 'DEBUG: ' . 'cancel_subscription_by_stripe_subscription_id(): ' . "stripeSubscriptionID={$stripeSubscriptionID}" );
		global $wpdb;
	...
	public function complete_subscription_by_stripe_subscription_id( $stripeSubscriptionID ) {
		error_log( 'DEBUG: ' . 'complete_subscription_by_stripe_subscription_id(): ' . "stripeSubscriptionID={$stripeSubscriptionID}" );
		global $wpdb;
	...
	public function update_subscription_with_payment( $stripeSubscriptionID ) {
		error_log( 'DEBUG: ' . 'update_subscription_with_payment(): ' . "increment chargeCurrentCount, stripeSubscriptionID={$stripeSubscriptionID}" );
		global $wpdb;
	...
	public function find_subscriber_by_id( $id ) {
		error_log( 'DEBUG: ' . 'find_subscriber_by_id(): ' . "find subscription, id={$id}" );
		global $wpdb;
	...
	public function find_subscription_by_stripe_subscription_id( $stripe_subscription_id ) {
		error_log( 'DEBUG: ' . 'find_subscription_by_stripe_subscription_id(): ' . "find subscription, stripe_subscription_id={$stripe_subscription_id}" );
		global $wpdb;
