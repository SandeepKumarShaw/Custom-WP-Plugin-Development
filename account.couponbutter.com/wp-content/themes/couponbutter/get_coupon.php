...
//echo $_SESSION['coupon_id'];
        ...
        //$cpn_disc = wordwrap($cpn_discount,16,"<br>\n");
        ...
        <h2><?php echo $rows->coupon_discount; ?> <?php //echo $rows->coupon_purchase_amount; ?></h2>
        ...
        <div class="submit_login-bx_in">
			...
			if (isset($_POST['submit'])){ 
                //echo"hello";
            $row8_1="SELECT customer_email  FROM wp_customer_details WHERE parent_id ='".$cust_id."' OR customer_id='".$cust_id."'";
