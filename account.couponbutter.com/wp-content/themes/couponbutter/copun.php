...
<div class="menu_header">
       ...
       <div class="coupon-feaddd"> MANAGE COUPON </div>
        ...
        <p class="cou-nam"><?php echo $row6->coupon_name; ?></p>
        <p>Expires<span class="sh-coupon">:</span><?php echo $row6->coupon_end_date;?><p>
        <p>Discount Amount<span class="sh-coupon">:</span><?php echo $row6->coupon_discount;?></p>
  ...
  <?php 
    ...
    //exit;
      ...
      if($cou_pon_id)
      {
       ...
       foreach ($san as $sans) { ?>
        <select class="form-control sel2" id="sel2" name="number2" rel="<?php echo $_SESSION['coupon_id']; ?>">
<option data-coupid="<?php echo $_SESSION['coupon_id']; ?>" selected="selected" value="<?php echo $sans->customer_id;?>"> <?php echo $sans->customer_name; ?></option>
</select>
<?php } }  else { ?>
<?php
    $i==0;
   $sql9="SELECT * FROM wp_customer_details WHERE parent_id = 0 AND subscriber_id = '".$_SESSION['user_id']."' AND customer_cuppon_id = 0";
   ...
   ?>
      ...
      <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/bootstrap.min.js"></script>
        ...
        <p><span><i class="fa fa-trash-o" aria-hidden="true"></i></span>delete customer</p>
        </div></a>
        </div>
   ...
   // wp_redirect("http://account.couponbutter.com/get-coupon/");
} ?>
...
<!--<div class="Redemmed">
       <p>Coupons Redemmed<p>
        ...
        <div class="name_coupon_1">
        <p>
          <div class="coupon-feadd">CREATE COUPON</div>
 ...
 <form class="form-horizontal" id="createcouponForm" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="resturantname" id="coupon-name" placeholder="Enter Coupon Name" class="form-control" autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="resturantweb" id="coupon-name" placeholder="Enter Coupon Name" class="form-control" autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="resturantadd" id="coupon-name" placeholder="Enter Coupon Name" class="form-control" autofocus>
        ...
        global $wpdb;
        if( $_SESSION['plan_id']=="CBInd"){
            $roln=$wpdb->query("SELECT coupon_id FROM `wp_coupon_create` WHERE cuppon_subscriber_id = '$_SESSION[user_id]'");
           // print_r($roln);
            if ($roln>=1) {
                echo"you have already a couppon";
            }elseif($roln==0){
            //echo"now you can create a coupon";
                 $name=$_POST['couponname'];

        $resturant_name=$_POST['resturantname'];
        $resturant_website=$_POST['resturantweb'];
        $resturant_address=$_POST['resturantadd'];
...
$sql="INSERT INTO $table_name SET  coupon_id='".$c_code."',coupon_name='".$name."',resturant_name='".$resturant_name."',resturant_website='".$resturant_website."',resturant_address='".$resturant_address."', coupon_status='".$cstatus."',coupon_discount='".$discount_amount."',coupon_start_date='".$date1."',coupon_end_date='".$date2."',coupon_phone='".$phone."',coupon_disclaimer='".$desclaimer."',coupon_logo='$icon_img_path',coupon_pdf_path='".$p_full."', coupon_image_path
='0',cuppon_subscriber_id='".$subscriber."',time_stamp='".time()."'"; 
         // echo $sql;
         // die(); 
         // exit();  
        ...
        }elseif ($_SESSION['plan_id']=="CBDev") {
	
           //echo"you have more";
//          include( get_template_directory() . '/couppon_innsert.php');
              $name=$_POST['couponname'];
