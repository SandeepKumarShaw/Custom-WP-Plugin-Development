...
<style type="text/css">
    ...
    .ordernow a{width: 200px;margin: 20px auto 0; text-align: center;padding: 5px 10px;font-size: 30px;display: block;background: #ff0000;color: #fff;border-radius: 3px;}
</style>
 <div class="main">
    <div class="content">
    	<div class="section group">
           <div class="division">
                        ...
                        <table class="tblone">
                            ...
                            if ($getPro) {$i=0;$sum=0;$qty=0;
                                while ($result = $getPro->fetch_assoc()) {$i++;
